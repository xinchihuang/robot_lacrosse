        ...
        if self.execute_stop == 1:
            ...
            for index in range(0,self.robot_num):
                ...
                if self.time_step %10==5:
                    set_joint_position(self.pub_revolute2, 0.0)
                    set_joint_position(self.pub_revolute6, 0.0)
                    set_joint_position(self.pub_revolute10, 0.0)
                elif self.time_step %10==0:
                    set_joint_position(self.pub_revolute2, -2.0)
                    set_joint_position(self.pub_revolute6, 1.0)
                    set_joint_position(self.pub_revolute10, 1.0)
                print(index)
            self.time_step+=1
